...
const Transporter = () => {
  ...
  useEffect(() => {
    fetch("https://go-click-back-end-main.vercel.app/product")
      .then((res) => res.json())
  ...
  const handleTransporterForm = (e) => {
    ...
    fetch(`https://go-click-back-end-main.vercel.app/product/${orderid}`, {
      method: "PUT",
      headers: {
  ...
  return (
    <div>
      ...
      <form
        ...
        action=""
        className="w-[500px] mx-auto p-8 rounded-md border-2 mb-10"
      >
        <div className="flex flex-col gap-1 mb-6">
          ...
          >
            {products.map((product) => (
              <option key={product._id} value={product.orderid}>
                {product.orderid}
              </option>
            ))}
          </select>
